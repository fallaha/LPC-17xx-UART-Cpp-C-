...
void UART :: uart0_init(void)
	...
	void UART :: sendchar0 (unsigned char ch) // send char to Uart 0
{
	...
	void UART :: sendchar1 (unsigned char ch) // send char to Uart 1
{
	...
	void UART :: sendchar2 (unsigned char ch) // send char to Uart 2
{
	...
	void UART :: sendchar3 (unsigned char ch) // send char to Uart 3
{
